...
<head>
    ...
    <title>Cadastro de Fotografias</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data" action="index.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="titulo" maxlength="80" class="form-control"
                                    id="exampleInputEmail1" placeholder="Entre com o título da fotografia">
                            </div>
                    ...
                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="regiao" maxlength="30" class="form-control"
                                    id="exampleInputEmail1"
                                    placeholder="Entre com a região onde a fotografia foi tirada">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="obs" class="form-control" rows="3"
                                    placeholder="Entre com alguma observação sobre a fotografia"></textarea>
                            </div>
                ...
                <?php
        // Verificar se clicou pra enviar
        if(isset($_POST['titulo'])){
            ...
            if(!empty($titulo) && !empty($cidade) && !empty($regiao) && !empty($data)){
                ...
                if(isset($_FILES['foto'])){
                    ...
                    // Define o diretório para onde o arquivo será enviado
                    $diretorio = "fotografias/";

                    // Efetua o upload
                    move_uploaded_file($_FILES['foto']['tmp_name'], $diretorio.$novo_nome);
                    $f->conectar("projeto_lori","localhost","root", "");
                    if($f->cadastrarFoto($titulo, $diretorio, $data, $cidade, $regiao, $obs, $extensao)){
                        echo "Fotografia cadastrada com sucesso!";
                    }
                    else{
